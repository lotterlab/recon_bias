...
source_directory = "/Volumes/Lotter_Seagate/USCF-PDGM/PKG - UCSF-PDGM-v3-20230111/UCSF-PDGM-v3"
destination_directory = "/Volumes/Lotter_Seagate/USCF-PDGM/PKG - UCSF-PDGM-v3-20230111/UCSF-PDGM-v3-reduced"
...
for patient_folder in os.listdir(source_directory):
    ...
    if os.path.isdir(patient_path):
        ...
        if flair_image and os.path.exists(flair_image):
            shutil.copy(flair_image, os.path.join(patient_destination, os.path.basename(flair_image)))
        
        if tumor_segmentation and os.path.exists(tumor_segmentation):
            shutil.copy(tumor_segmentation, os.path.join(patient_destination, os.path.basename(tumor_segmentation)))
