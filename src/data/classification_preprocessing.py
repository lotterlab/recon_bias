...
def process_patient_folder(parent_dir, patient_folder, metadata_file, split, output_file):
    """
...
def process_all_patients(source_directory, metadata_file, output_file, split='train'):
    ...
    with open(output_file, 'w', newline='') as csvfile:
        ...
        writer.writerow([
            ...
            'age_at_mri', 'who_cns_grade', 'final_diagnosis', 'alive', 'os',
            'split', 'type', 'edema', 'non_enhancing', 'enhancing'
        ])
